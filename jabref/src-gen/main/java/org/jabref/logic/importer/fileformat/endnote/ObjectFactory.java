...
public class ObjectFactory {
    ...
    private final static QName _RecNumber_QNAME = new QName("", "rec-number");
     ...
     */
    @XmlElementDecl(namespace = "", name = "rec-number")
    public JAXBElement<String> createRecNumber(String value) {
        return new JAXBElement<String>(_RecNumber_QNAME, String.class, null, value);
    }
