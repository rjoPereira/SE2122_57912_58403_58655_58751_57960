...
public class RightClickMenu {
    ...
    public static ContextMenu create(BibEntryTableViewModel entry,
        ...
        //
        contextMenu.getItems().add(factory.createMenuItem(StandardActions.SEARCH_GOOGLESCHOLAR, new GoogleScholarSearcher(entry.getEntry(), libraryTab.frame(), preferencesService, stateManager)));
